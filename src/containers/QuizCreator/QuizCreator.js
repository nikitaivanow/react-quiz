...
function createOptionControl(number) {
  return createControl({
        ...
        errorMessage: 'Значение не можут быть пустым',
        id:{number}
      }, {required: true})
    }
...
class QuizCreator extends Component {
  ...
  createQuizHandler = async (event) => {
    ...
    try{
      await axios.post('https://react-quiz-cbc4c-default-rtdb.europe-west1.firebasedatabase.app/quizes.json', this.state.quiz)
    ...
    // axios.post('https://react-quiz-cbc4c-default-rtdb.europe-west1.firebasedatabase.app/quizes.json', this.state.quiz)
    //   .then(response =>{
